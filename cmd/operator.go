...
import (
	...
	"github.com/launchboxio/cript/internal/controller"
...
func runOperator(cmd *cobra.Command, args []string) {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "709a5ea5.cript.dev",
	...
	if err = (&controller.ScanReconciler{
	...
	if err = (&controller.DeclarationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Declaration")
		os.Exit(1)
	}
